...
function About() {
  return <div id="About" className="border-2 border-transparent my-16 sm:mt-32 mt-52">
    ...
    <div className="grid md:flex lg:justify-around xl:mt-16 xl:justify-center">
        <img src={Image2} alt="" className="w-56 h-56 justify-self-center self-center rounded-3xl mt-7 md:h-60 md:w-60 lg:h-80 lg:w-80 lg:mx-16 xl:h-96 xl:w-96" />
