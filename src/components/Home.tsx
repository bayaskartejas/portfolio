  ...
  return <div className="w-full h-max md:mt-20 sm:mt-14 mt-20 sm:flex sm:justify-center">
    ...
    <div className="content-center sm:mx-10">
        ...
        <div className="w-full mt-5 lg:mt-11 flex justify-center h-11">
            <a href="https://drive.google.com/file/d/1vIPhCpN1yedoytig9jTO7aRUYCVz8CTm/view?usp=drive_link" target="blank"><button className="h-full w-32 mx-3 border-2 border-black rounded-3xl duration-100 hover:bg-zinc-800 hover:text-white">Résumé</button></a>
